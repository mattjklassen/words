# input:  a word of length at least 2, and integer e
# output: lists of possible extensions of this word
# by adding up to e letters
...
#
# word is a word (or alpha), e is the depth for extension
# so if word has length 4 letters, and e=2, then we are
# finding all extensions of this word by up to 2 letters.
